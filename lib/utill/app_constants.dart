...
class AppConstants {
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.enl, languageName: 'English', countryCode: 'US', languageCode: 'en'),
    LanguageModel(imageUrl: Images.enl, languageName: 'Arabic', countryCode: 'SA', languageCode: 'ar'),
    LanguageModel(imageUrl: Images.enl, languageName: 'French', countryCode: 'FR', languageCode: 'fr'),
  ];
}
